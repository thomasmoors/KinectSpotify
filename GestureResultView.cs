...
namespace Microsoft.Samples.Kinect.DiscreteGestureBasics
{
    ...
    public sealed class GestureResultView : INotifyPropertyChanged
    {
        ...
        public void UpdateGestureResult(bool isBodyTrackingIdValid, bool isGestureDetected, float detectionConfidence, KinectGesture currentGesture)
        {
            ...
            else
            {
                ...
                {
                    //control spotify
                    SpotifyHelper.controlSpotify(currentGesture.sa);
